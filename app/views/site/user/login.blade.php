...
{{-- Content --}}
@section('content')
<div class="copagrande"></div>
<div class="page-header">
	<h1>{{ Lang::get('site.login.title') }}</h1>
</div>
<form class="form-horizontal" method="POST" action="{{ URL::to('user/login') }}" accept-charset="UTF-8">
    <input type="hidden" name="_token" value="{{ csrf_token() }}">
    <fieldset>
        <div class="form-group">
            <label class="col-md-4 control-label" for="email">{{ Lang::get('confide::confide.username_e_mail') }}</label>
            <div class="col-md-8">
        ...
        <div class="form-group">
            <div class="col-md-11 pull-right">
                ...
                <a class="btn btn-default" href="create">{{ Lang::get('confide::confide.signup.submit') }}</a>
...
@section('contentderecha')
    <div class="banner-login ">
        <div class="banner"><img src="{{ asset('uploads/prode/353x225_crop/' . Prode::find(1)->bannerlogin) }}" /></div>
    </div>
