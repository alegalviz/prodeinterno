            ...
            <div class="container">
    			...
    			<div class="collapse navbar-collapse navbar-ex1-collapse">
    				<ul class="nav navbar-nav">
                        ...
                        <li{{ (Request::is('admin/posts*') ? ' class="active"' : '') }}><a href="{{{ URL::to('admin/posts') }}}"><span class="glyphicon glyphicon-list-alt"></span> Posts</a></li>
                        ...
                        <li{{ (Request::is('admin/estadios*') ? ' class="active"' : '') }}><a href="{{{ URL::to('admin/estadios') }}}"><span class="glyphicon glyphicon-bullhorn"></span> Estadios</a></li>
                        <li{{ (Request::is('admin/partidos*') ? ' class="active"' : '') }}><a href="{{{ URL::to('admin/partidos') }}}"><span class="glyphicon glyphicon-time"></span> Partidos</a></li>


                    </ul>
    				<ul class="nav navbar-nav pull-right">
    					<li><a href="{{{ URL::to('/') }}}">View Homepage</a></li>
                        <li{{ (Request::is('admin/prodes*') ? ' class="active"' : '') }}><a href="{{{ URL::to('admin/prodes') }}}"><span class="glyphicon glyphicon-wrench"></span> Prode</a></li>
