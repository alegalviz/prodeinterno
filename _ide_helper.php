...
namespace {
	...
	class Image extends \App\Facades\ImageFacade{
		 ...
		 */
		 public static function __construct(){
			//Method inherited from \App\Services\Image
			 \App\Services\Image::__construct();
		 }
		 ...
		 * @static 
		 */
		 public static function thumb($url, $width, $height = null){
			//Method inherited from \App\Services\Image
			return \App\Services\Image::thumb($url, $width, $height);
		 }
		 ...
		 * @static 
		 */
		 public static function upload($file, $dir = null, $createDimensions = false){
			//Method inherited from \App\Services\Image
			return \App\Services\Image::upload($file, $dir, $createDimensions);
		 }
		 ...
		 */
		 public static function createDimensions($url, $dimensions = array()){
			//Method inherited from \App\Services\Image
			 \App\Services\Image::createDimensions($url, $dimensions);
		 }
	...
	class Iseed extends \Orangehill\Iseed\Facades\Iseed{
		 ...
		 * @static 
		 */
		 public static function __construct($filesystem = null){
			//Method inherited from \Orangehill\Iseed\Iseed
			 \Orangehill\Iseed\Iseed::__construct($filesystem);
		 }
		 ...
		 * @static 
		 */
		 public static function generateSeed($table){
			//Method inherited from \Orangehill\Iseed\Iseed
			 \Orangehill\Iseed\Iseed::generateSeed($table);
		 }
		 ...
		 */
		 public static function getData($table){
			//Method inherited from \Orangehill\Iseed\Iseed
			return \Orangehill\Iseed\Iseed::getData($table);
		 }
